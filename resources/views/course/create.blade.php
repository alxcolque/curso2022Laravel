                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('courses.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="begin_date" type="datetime-local" class="form-control @error('begin_date') is-invalid @enderror" name="begin_date" value="{{ old('begin_date') }}" required autocomplete="begin_date">
